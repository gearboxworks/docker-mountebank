...
Create, and start version **2.2.1** of the **mountebank** [Gearbox](https://github.com/gearboxworks/) container and run a shell with commands.

**./bin/launch shell mountebank:2.2.1 ls -l**

```
me@home:~ % ./bin/launch shell mountebank:2.2.1 ls -l
Gearbox: Gear 'mountebank:2.2.1' already started.
total 60
...
**./bin/launch shell mountebank:2.2.1 ps -eaf**

```
me@home:~ % ./bin/launch shell mountebank:2.2.1 ps -eaf
Gearbox: Gear 'mountebank:2.2.1' already started.
...
+----------+----------------------------------+-------+--------+
| graphics | gearboxworks/mountebank:2.2.1  |       |  40 MB |
+----------+----------------------------------+-------+--------+
...
+---------------------+----------+---------+----------------------------------+-------+----------+---------------+--------+--------+
| mountebank-2.2.1  | graphics | created | gearboxworks/mountebank:2.2.1  |       |          | (gearboxnet)  |        |  40 MB |
|                     |          |         |                                  |       |          |               |        |        |
+---------------------+----------+---------+----------------------------------+-------+----------+---------------+--------+--------+
...
`./bin/launch run mountebank:2.2.1 -flag1 -flag2 variable1 variable2 variable3`
...
* * *
**Note: This README was generated by `JsonToConfig` - Created on 2021-03-18T10:53:22+1100, using template:README.md.tmpl and json:gearbox.json**