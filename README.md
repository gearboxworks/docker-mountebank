...
| -------------------- | ---------------------------------------- |
|(default command) | /usr/local/bin/mb.sh |
...
* * *
**Note: This README was generated by `JsonToConfig` - Created on 2021-03-07T19:13:38+1100, using template:README.md.tmpl and json:gearbox.json**
